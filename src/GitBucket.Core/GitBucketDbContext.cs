...
public partial class GitBucketDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccessTokenId).HasName("idx_access_token_pk");

            entity.ToTable("access_token");

            entity.HasIndex(e => e.TokenHash, "idx_access_token_token_hash").IsUnique();
            ...
            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.AccessTokens)
        ...
        {
            entity.HasKey(e => e.UserName).HasName("idx_account_pk");

            entity.ToTable("account");

            entity.HasIndex(e => e.MailAddress, "idx_account_1").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.UserName, e.ExtraMailAddress }).HasName("idx_account_extra_mail_address_pk");

            entity.ToTable("account_extra_mail_address");

            entity.HasIndex(e => e.ExtraMailAddress, "idx_account_extra_mail_address_1").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.Issuer, e.Subject }).HasName("idx_account_federation_pk");
            ...
            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.AccountFederations)
                .HasForeignKey(d => d.UserName)
        ...
        {
            entity.HasKey(e => e.UserName).HasName("idx_account_preference_pk");
            ...
            entity.HasOne(d => d.UserNameNavigation).WithOne(p => p.AccountPreference)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.Url }).HasName("idx_account_web_hook_pk");
            ...
            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.AccountWebHooks)
                .HasForeignKey(d => d.UserName)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<AccountWebHookEvent>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("account_web_hook_event");
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.CollaboratorName }).HasName("idx_collaborator_pk");
            ...
            entity.HasOne(d => d.CollaboratorNameNavigation).WithMany(p => p.Collaborators)
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("idx_commit_comment_pk");
            ...
            entity.HasOne(d => d.Repository).WithMany(p => p.CommitComments)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.CommitStatusId).HasName("idx_commit_status_pk");

            entity.ToTable("commit_status");

            entity.HasIndex(e => new { e.UserName, e.RepositoryName, e.CommitId, e.Context }, "idx_commit_status_1").IsUnique();
            ...
            entity.HasOne(d => d.CreatorNavigation).WithMany(p => p.CommitStatusCreatorNavigations)
                .HasForeignKey(d => d.Creator)
                .HasConstraintName("idx_commit_status_fk3");

            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.CommitStatusUserNameNavigations)
                .HasForeignKey(d => d.UserName)
                .HasConstraintName("idx_commit_status_fk2");

            entity.HasOne(d => d.Repository).WithMany(p => p.CommitStatuses)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
        ...
        modelBuilder.Entity<DeployKey>(entity =>
        {
            ...
            entity.HasIndex(e => e.DeployKeyId, "deploy_key_deploy_key_id_key").IsUnique();
            ...
            entity.HasOne(d => d.Repository).WithMany(p => p.DeployKeys)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName }).HasName("idx_gist_pk");
            ...
            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.Gists)
                .HasForeignKey(d => d.UserName)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("idx_gist_comment_pk");

            entity.ToTable("gist_comment");

            entity.HasIndex(e => new { e.UserName, e.RepositoryName, e.CommentId }, "idx_gist_comment_1").IsUnique();
            ...
            entity.HasOne(d => d.CommentedUserNameNavigation).WithMany(p => p.GistComments)
                .HasForeignKey(d => d.CommentedUserName)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("idx_gist_comment_fk1");

            entity.HasOne(d => d.Gist).WithMany(p => p.GistComments)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.GpgKeyId }).HasName("idx_gpg_key_pk");

            entity.ToTable("gpg_key");

            entity.HasIndex(e => e.KeyId, "gpg_key_key_id_key").IsUnique();
            ...
            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.GpgKeys)
                .HasForeignKey(d => d.UserName)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.GroupName, e.UserName }).HasName("idx_group_member_pk");
            ...
            entity.HasOne(d => d.GroupNameNavigation).WithMany(p => p.GroupMemberGroupNameNavigations)
                .HasForeignKey(d => d.GroupName)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("idx_group_member_fk0");

            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.GroupMemberUserNameNavigations)
                .HasForeignKey(d => d.UserName)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.IssueId }).HasName("idx_issue_pk");
            ...
            entity.HasOne(d => d.Milestone).WithMany(p => p.Issues)
                .HasPrincipalKey(p => p.MilestoneId)
                .HasForeignKey(d => d.MilestoneId)
                .HasConstraintName("idx_issue_fk2");

            entity.HasOne(d => d.OpenedUserNameNavigation).WithMany(p => p.Issues)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName }).HasName("idx_issue_id_pk");
            ...
            entity.HasOne(d => d.Repository).WithOne(p => p.IssueId)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.IssueId, e.LabelId }).HasName("idx_issue_label_pk");
            ...
            entity.HasOne(d => d.Issue).WithMany(p => p.IssueLabels)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName, d.IssueId })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.IssueId, e.NotificationUserName }).HasName("idx_issue_notification_pk");
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.LabelId }).HasName("idx_label_pk");

            entity.ToTable("label");

            entity.HasIndex(e => e.LabelId, "label_label_id_key").IsUnique();
            ...
            entity.HasOne(d => d.Repository).WithMany(p => p.Labels)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.MilestoneId }).HasName("idx_milestone_pk");

            entity.ToTable("milestone");

            entity.HasIndex(e => e.MilestoneId, "milestone_milestone_id_key").IsUnique();
            ...
            entity.HasOne(d => d.Repository).WithMany(p => p.Milestones)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.UserName).HasName("idx_notifications_account_pk");
            ...
            entity.HasOne(d => d.UserNameNavigation).WithOne(p => p.NotificationsAccount)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName }).HasName("idx_pages_pk");
        ...
        {
            entity.HasKey(e => e.PluginId).HasName("idx_plugin_pk");
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.PriorityId }).HasName("idx_priority_pk");

            entity.ToTable("priority");

            entity.HasIndex(e => e.PriorityId, "priority_priority_id_key").IsUnique();
            ...
            entity.HasOne(d => d.Repository).WithMany(p => p.Priorities)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.Branch }).HasName("idx_protected_branch_pk");
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.Branch, e.Context }).HasName("idx_protected_branch_require_context_pk");
            ...
            entity.HasOne(d => d.ProtectedBranch).WithMany(p => p.ProtectedBranchRequireContexts)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.IssueId }).HasName("idx_pull_request_pk");
            ...
            entity.HasOne(d => d.Issue).WithOne(p => p.PullRequestNavigation)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.Tag, e.FileName }).HasName("idx_release_asset_pk");

            entity.ToTable("release_asset");

            entity.HasIndex(e => e.ReleaseAssetId, "release_asset_release_asset_id_key").IsUnique();
            ...
            entity.HasOne(d => d.ReleaseTag).WithMany(p => p.ReleaseAssets)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.Tag }).HasName("idx_release_tag_pk");
            ...
            entity.HasOne(d => d.Repository).WithMany(p => p.ReleaseTags)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName }).HasName("idx_repository_pk");
            ...
            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.Repositories)
                .HasForeignKey(d => d.UserName)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.SshKeyId }).HasName("idx_ssh_key_pk");

            entity.ToTable("ssh_key");

            entity.HasIndex(e => e.SshKeyId, "ssh_key_ssh_key_id_key").IsUnique();
            ...
            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.SshKeys)
                .HasForeignKey(d => d.UserName)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.NotificationUserName }).HasName("idx_watch_pk");
        ...
        {
            entity.HasKey(e => e.HookId).HasName("idx_web_hook_pk");
            ...
            entity.HasOne(d => d.Repository).WithMany(p => p.WebHooks)
                .HasForeignKey(d => new { d.UserName, d.RepositoryName })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UserName, e.RepositoryName, e.Url, e.Event }).HasName("idx_web_hook_event_pk");
            ...
            entity.HasOne(d => d.WebHook).WithMany(p => p.WebHookEvents)
